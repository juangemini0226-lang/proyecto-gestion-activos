...
SECRET_KEY = 'django-insecure-_^b_8k@^+oal*f+qm!+0m3n^tupaf+!hn2i$n*wbn1e&-or44p'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://gestionmtto-c7bb849b9c23.herokuapp.com/' , 'localhost']
...
# Si un usuario no ha iniciado sesión, redirígelo a esta URL
LOGIN_URL = '/accounts/login/'

# Después de que un usuario inicie sesión correctamente, redirígelo a la página de inicio
LOGIN_REDIRECT_URL = '/' 
